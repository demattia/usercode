...
#
#
# Unbiased Stand Alone Muons Producer
unbiasedStandAloneMuons = standAloneMuons.clone()
# Final smoothing
unbiasedStandAloneMuons.STATrajBuilderParameters.DoRefit = True
# Segment based fit
unbiasedStandAloneMuons.STATrajBuilderParameters.BWFilterParameters.MuonTrajectoryUpdatorParameters.Granularity = 0
