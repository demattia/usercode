...
#events = Events ('root://xrootd.rcac.purdue.edu//store/user/demattia/longlived/CMSSW_4_2_7/Signal_200_050F/pat/PATtuple_2_1_lE8.root')
...
#c1 = ROOT.TCanvas()
#ptMuHist.Draw()
#c1.Print ("ptMuHist.png")
c3 = ROOT.TCanvas()
transIPMuonHist.Draw()
c3.Print ("transIPMuon_Signal_120_020F.png")
