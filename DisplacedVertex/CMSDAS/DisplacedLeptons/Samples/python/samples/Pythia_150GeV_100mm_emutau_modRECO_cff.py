...
sampleGeneratorReference = "python/generator/Pythia_H0_pyupda_cfi.py"
...
for i in range(40):
    sampleRecoFiles.append(sampleBaseDir\
                          +"/modreco/Pythia_H0_pyupda_cfi_py_RAW2DIGI_RECO_"\
                          +str(i+1)+".root")

samplePatFiles = [ sampleBaseDir+"/pat/PATtuple_modreco.root" ]
