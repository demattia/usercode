...
# with command line options: step2 --datatier GEN-SIM-DIGI-RAW-HLTDEBUG --conditions auto:startup -s DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,L1Reco --eventcontent FEVTDEBUGHLT -n 100 --no_exec --filein file:step1.root --fileout file:step2.root
