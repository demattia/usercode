...
# with command line options: step3 --datatier GEN-SIM-RECO,DQM --conditions auto:startup -s RAW2DIGI,L1Reco,RECO,VALIDATION,DQM --eventcontent RECOSIM,DQM -n 100 --no_exec --filein file:step2.root --fileout file:step3.root
...
process.RECOSIMEventContent.outputCommands.extend(cms.untracked.vstring('keep *_hltL2Muons_*_*', 'keep *_hltL3Muons_*_*'))
