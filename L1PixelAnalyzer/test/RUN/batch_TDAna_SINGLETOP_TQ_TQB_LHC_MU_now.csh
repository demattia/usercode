...
cmsRun /afs/cern.ch/user/d/dorigo/scratch0/CMSSW_1_7_0/src/AnalysisExamples/L1PixelAnalyzer/test/RUN/TDAna_SINGLETOP_TQ_TQB_LHC_MU_now.cfg
rfcp TDAna_SINGLETOP_TQ_TQB_LHC_MU.root /castor/cern.ch/user/d/dorigo/TDAna/
rfcp T.asc /castor/cern.ch/user/d/dorigo/TDAna/T_SINGLETOP_TQ_TQB_LHC_MU.asc
rfcp H.asc /castor/cern.ch/user/d/dorigo/TDAna/H_SINGLETOP_TQ_TQB_LHC_MU.asc
rfcp tthdecays.asc /castor/cern.ch/user/d/dorigo/TDAna/SINGLETOP_TQ_TQB_LHC_MU_decays.asc
