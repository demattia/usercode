...
cmsRun /afs/cern.ch/user/d/dorigo/scratch0/CMSSW_1_7_0/src/AnalysisExamples/L1PixelAnalyzer/test/RUN/TDAna_TT_4JETS_now.cfg
rfcp TDAna_TT_4JETS.root /castor/cern.ch/user/d/dorigo/TDAna/
rfcp T.asc /castor/cern.ch/user/d/dorigo/TDAna/T_TT_4JETS.asc
rfcp H.asc /castor/cern.ch/user/d/dorigo/TDAna/H_TT_4JETS.asc
rfcp tthdecays.asc /castor/cern.ch/user/d/dorigo/TDAna/TT_4JETS_decays.asc
