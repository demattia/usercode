...
cmsRun /afs/cern.ch/user/d/dorigo/scratch0/CMSSW_1_7_0/src/AnalysisExamples/L1PixelAnalyzer/test/RUN/TDAna_W_0JETS_w.cfg
rfcp TDAna_W_0JETS.root /castor/cern.ch/user/d/dorigo/TDAna/
rfcp T.asc /castor/cern.ch/user/d/dorigo/TDAna/T_W_0JETS.asc
rfcp H.asc /castor/cern.ch/user/d/dorigo/TDAna/H_W_0JETS.asc
rfcp tthdecays.asc /castor/cern.ch/user/d/dorigo/TDAna/W_0JETS_decays.asc
