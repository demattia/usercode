...
cmsRun /afs/cern.ch/user/d/dorigo/scratch0/CMSSW_1_7_0/src/AnalysisExamples/L1PixelAnalyzer/test/RUN/TDAna_TT_3JETS_now.cfg
rfcp TDAna_TT_3JETS.root /castor/cern.ch/user/d/dorigo/TDAna/
rfcp T.asc /castor/cern.ch/user/d/dorigo/TDAna/T_TT_3JETS.asc
rfcp H.asc /castor/cern.ch/user/d/dorigo/TDAna/H_TT_3JETS.asc
rfcp tthdecays.asc /castor/cern.ch/user/d/dorigo/TDAna/TT_3JETS_decays.asc
