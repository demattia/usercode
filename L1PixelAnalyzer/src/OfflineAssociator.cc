...
#include "AnalysisExamples/L1PixelAnalyzer/interface/OfflineAssociator.h"
...
// ---------------------------
OfflineAssociator::OfflineAssociator(const edm::ParameterSet& iConfig) :
  conf_( iConfig ),
...
OfflineAssociator::~OfflineAssociator()
{
...
// ----------------------------------------------------------
void OfflineAssociator::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
...
//   //Tracks Impact Parameter collection
//   edm::Handle<SimpleTrackCollection> simpleTracks;
  
//   try {
//     iEvent.getByLabel( simpleTrackLabel_ ,simpleTracks );
//   }
//   catch (...) {
//     std::cerr << "Could not find the b-tagging collection" << std::endl;
//     return;
...
// -------------------------------------------------------------------------
void OfflineAssociator::beginJob(const edm::EventSetup&) {
}


//       method called once each job just after ending the event loop 
// -------------------------------------------------------------------------
void OfflineAssociator::endJob() {
...
// ------------------------
DEFINE_FWK_MODULE(OfflineAssociator);
