// -*- C++ -*-
//
// Package:    OfflineAssociator
// Class:      OfflineAssociator
//
// Code extracted from Roberto.cc, 02/04/08 R.Casagrande
//
/**\class OfflineAssociator OfflineAssociator.cc AnalysisExamples/OfflineAssociator/src/OfflineAssociator.cc

Description: <one line class summary>

*/
//
// $Id: OfflineAssociator.h
//
//
...
// Class declaration
// -----------------
class OfflineAssociator : public edm::EDAnalyzer {
public:
  explicit OfflineAssociator(const edm::ParameterSet&);
  ~OfflineAssociator();
...
private:
  ...
  // than one OfflineAssociator object is created
  // -------------------------------------------------------
  ...
  // the OfflineAssociator constructor ).
  //  HiVariables HiVar;
