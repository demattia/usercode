// -*- C++ -*-
//
// Package:    RecoAssociator
// Class:      RecoAssociator
//
// Code extracted from Roberto.cc, 02/04/08 R.Casagrande
//
/**\class RecoAssociator RecoAssociator.cc AnalysisExamples/RecoAssociator/src/RecoAssociator.cc
...
// Class declaration
// -----------------
class RecoAssociator : public edm::EDAnalyzer {
public:
  explicit RecoAssociator(const edm::ParameterSet&);
  ~RecoAssociator();
...
private:
  ...
  // than one RecoAssociator object is created
  // -------------------------------------------------------
  ...
  // the RecoAssociator constructor ).
  //  HiVariables HiVar;
