// -*- C++ -*-
//
// Package:    TDAnaProducer
// Class:      TDAnaProducer
// 
/**\class TDAnaProducer TDAnaProducer.cc AnalysisExamples/TDAnaProducer/src/TDAnaProducer.cc
...
// $Id: TDAnaProducer.h,v 1.33 2008/02/08 10:53:27 dorigo Exp $
//
//
...
// Class declaration
// -----------------
class TDAnaProducer : public edm::EDProducer {
 public:
  explicit TDAnaProducer(const edm::ParameterSet&);
  ~TDAnaProducer();
...
//   double PI_;
  ...
  // than one TDAnaProducer object is created
  // -------------------------------------------------------
