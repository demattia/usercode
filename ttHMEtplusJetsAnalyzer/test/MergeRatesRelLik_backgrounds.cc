...
void hadd() {
  ...
  Target = TFile::Open( "RelativeLikelihood_background.root", "RECREATE" );
  ...
  FileList->Add( TFile::Open("RelativeLikelihood_QCD_background.root") );    // 1
  FileList->Add( TFile::Open("RelativeLikelihood_TT_background.root") );     // 2
