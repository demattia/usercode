...
void hadd() {
  ...
  Target = TFile::Open( "RelativeLikelihood_TTH_120_norm.root", "RECREATE" );
  ...
  FileList->Add( TFile::Open("RelativeLikelihood_TTH_120.root") );    // 1

  // Do not scale them, they are already scaled.
  double crossSections[] = { 0.667 *100000 / 76516 };
