...
struct TreeLepton
{
  TreeLepton() :
    ...
    trackIso(-999.), ecalIso(-999.), hcalIso(-999.), normChi2(-999.),
    numberOfValidTrackerHits(-999), numberOfValidPixelHits(-999), numberOfValidMuonHits(-999), numberOfMatchedStations(-999)
  {}
  Float_t pt;
  Float_t eta;
  Float_t phi;
