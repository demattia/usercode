...
void Convert40pbPPtreeToHItree_HIcuts(){
	TFile *f = new TFile("/Users/demattia/HeavyIons/data_40pb.root");
	...
	t->SetBranchAddress("mu1_HLT_DoubleMu0", &mu1_HLT_L1DoubleMuOpen);
	...
	t->SetBranchAddress("mu2_HLT_DoubleMu0", &mu2_HLT_L1DoubleMuOpen);
