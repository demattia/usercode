...
int main( void ) 
{
   ...
   Double_t bTagTkInvMass, chi2ofMasses, deltaEtaHadronicTopHiggs, deltaPhiMEtNthLeadingJet_1, deltaPhiMEtNthLeadingJet_2, deltaPhiMEtNthLeadingJet_3;
   Double_t firstNjetsCentrality_1, firstNjetsCentrality_2, firstNjetsMass_1, firstNjetsMass_2, goodHt, hadronicTopMass, hadronicTopPlusHiggsMass;
   Double_t hadronicTopProjectionAlongHiggsDirection, hadronicWmass, higgsMass, mEtSig;
   // Double_t remainingJetsMass;
   Double_t sixthJetEt, sumHighEffDiscriminantFirst4Jets, sumHighEffDiscriminantFirst6Jets;
   reader->AddVariable("bTagTkInvMass", &bTagTkInvMass );
   reader->AddVariable("chi2ofMasses", &chi2ofMasses );
   reader->AddVariable("deltaEtaHadronicTopHiggs", &deltaEtaHadronicTopHiggs );
   reader->AddVariable("deltaPhiMEtNthLeadingJet_1", &deltaPhiMEtNthLeadingJet_1 );
   reader->AddVariable("deltaPhiMEtNthLeadingJet_2", &deltaPhiMEtNthLeadingJet_2 );
   reader->AddVariable("deltaPhiMEtNthLeadingJet_3", &deltaPhiMEtNthLeadingJet_3 );
   reader->AddVariable("firstNjetsCentrality_1", &firstNjetsCentrality_1 );
   reader->AddVariable("firstNjetsCentrality_2", &firstNjetsCentrality_2 );
   reader->AddVariable("firstNjetsMass_1", &firstNjetsMass_1 );
   reader->AddVariable("firstNjetsMass_2", &firstNjetsMass_2 );
   reader->AddVariable("goodHt", &goodHt );
   reader->AddVariable("hadronicTopMass", &hadronicTopMass );
   reader->AddVariable("hadronicTopPlusHiggsMass", &hadronicTopPlusHiggsMass );
   reader->AddVariable("hadronicTopProjectionAlongHiggsDirection", &hadronicTopProjectionAlongHiggsDirection );
   reader->AddVariable("hadronicWmass", &hadronicWmass );
   reader->AddVariable("higgsMass", &higgsMass );
   reader->AddVariable("mEtSig", &mEtSig );
   // reader->AddVariable("remainingJetsMass", &remainingJetsMass );
   reader->AddVariable("sixthJetEt", &sixthJetEt );
   reader->AddVariable("sumHighEffDiscriminantFirst4Jets", &sumHighEffDiscriminantFirst4Jets );
   reader->AddVariable("sumHighEffDiscriminantFirst6Jets", &sumHighEffDiscriminantFirst6Jets );
...
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsTTH_120.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_30-50.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_50-80.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_80-120.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_120-170.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_170-230.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_230-300.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_300-380.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsQCD_380-incl.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsTT_0JETS.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsTT_1JETS.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsTT_2JETS.root" );
//   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsTT_3JETS.root" );
   TFile * input = TFile::Open( "/data/demattia/CMSSW_1_8_4/src/AnalysisExamples/ttHMEtplusJetsAnalyzer/test/newBackup/tmva_2tagsTT_4JETS.root" );
...
//   TTree *theTree = (TTree*)input->Get("tree__2tagsTTH_120");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_30-50");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_50-80");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_80-120");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_120-170");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_170-230");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_230-300");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_300-380");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsQCD_380-incl");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsTT_0JETS");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsTT_1JETS");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsTT_2JETS");
//   TTree *theTree = (TTree*)input->Get("tree__2tagsTT_3JETS");
   TTree *theTree = (TTree*)input->Get("tree__2tagsTT_4JETS");
   ...
   theTree->SetBranchAddress("bTagTkInvMass", &bTagTkInvMass );
   theTree->SetBranchAddress("chi2ofMasses", &chi2ofMasses );
   theTree->SetBranchAddress("deltaEtaHadronicTopHiggs", &deltaEtaHadronicTopHiggs );
   theTree->SetBranchAddress("deltaPhiMEtNthLeadingJet_1", &deltaPhiMEtNthLeadingJet_1 );
   theTree->SetBranchAddress("deltaPhiMEtNthLeadingJet_2", &deltaPhiMEtNthLeadingJet_2 );
   theTree->SetBranchAddress("deltaPhiMEtNthLeadingJet_3", &deltaPhiMEtNthLeadingJet_3 );
   theTree->SetBranchAddress("firstNjetsCentrality_1", &firstNjetsCentrality_1 );
   theTree->SetBranchAddress("firstNjetsCentrality_2", &firstNjetsCentrality_2 );
   theTree->SetBranchAddress("firstNjetsMass_1", &firstNjetsMass_1 );
   theTree->SetBranchAddress("firstNjetsMass_2", &firstNjetsMass_2 );
   theTree->SetBranchAddress("goodHt", &goodHt );
   theTree->SetBranchAddress("hadronicTopMass", &hadronicTopMass );
   theTree->SetBranchAddress("hadronicTopPlusHiggsMass", &hadronicTopPlusHiggsMass );
   theTree->SetBranchAddress("hadronicTopProjectionAlongHiggsDirection", &hadronicTopProjectionAlongHiggsDirection );
   theTree->SetBranchAddress("hadronicWmass", &hadronicWmass );
   theTree->SetBranchAddress("higgsMass", &higgsMass );
   theTree->SetBranchAddress("mEtSig", &mEtSig );
   // theTree->SetBranchAddress("remainingJetsMass", &remainingJetsMass );
   theTree->SetBranchAddress("sixthJetEt", &sixthJetEt );
   theTree->SetBranchAddress("sumHighEffDiscriminantFirst4Jets", &sumHighEffDiscriminantFirst4Jets );
   theTree->SetBranchAddress("sumHighEffDiscriminantFirst6Jets", &sumHighEffDiscriminantFirst6Jets );
