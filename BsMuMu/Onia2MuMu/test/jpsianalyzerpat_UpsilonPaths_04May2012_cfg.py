...
process.demo = cms.EDAnalyzer('JPsiAnalyzerPAT',
    ...
    HLTBitNames_DoubleMu = cms.vstring(
																			 ...
																			 "HLT_Dimuon0_Upsilon_v14",#5E33, v4.4-4.11, 2012
																			 "HLT_Dimuon5_Upsilon_v3",#5E33, v4.4-4.11, 2012
																			 "HLT_Dimuon7_Upsilon_v3",#5E33, v4.4-4.11, 2012
																			 "HLT_Dimuon8_Upsilon_v3",#5E33, v4.4-4.11, 2012
																			 "HLT_Dimuon11_Upsilon_v3",#5E33, v4.4-4.11, 2012
																			 "HLT_Dimuon0_Upsilon_Muon_v15",#5E33, ?!?!?, 2012
                                       
                                       ),
   # ONE FILTER NAME PER PATH    
   HLTLastFilterNames_DoubleMu = cms.vstring(
																						 "hltVertexmumuFilterUpsilon", #HLT_Dimuon0_Upsilon_v14
																						 "hltVertexmumuFilterDimuon5Upsilon", #HLT_Dimuon5_Upsilon_v3 
																						 "hltVertexmumuFilterDimuon7Upsilon", #HLT_Dimuon7_Upsilon_v3
																						 "hltVertexmumuFilterDimuon8Upsilon", #HLT_Dimuon8_Upsilon_v3
																						 "hltVertexmumuFilterDimuon11Upsilon", #HLT_Dimuon11_Upsilon_v3
                                             "hltVertexmumuFilterUpsilonMuon", #HLT_Dimuon0_Upsilon_Muon_v15
                                             ),
...
# myLumis = LumiList.LumiList(filename = 'Cert_190456-190688_8TeV_PromptReco_Collisions12_JSON_MuonPhys.txt').getCMSSWString().split(',')
