...
cp -rf Data_endcaps_figs_3h ../BsMuMuLatex/Figures/VariablesComparison/
...
cp -rf MC_barrel_figs_3h ../BsMuMuLatex/Figures/VariablesComparison/
...
cp -rf MC_endcaps_figs_3h ../BsMuMuLatex/Figures/VariablesComparison/
