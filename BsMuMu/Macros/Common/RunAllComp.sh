...
${rootExecutable} -l -b -q comp.C++\(\"../Barrel_preselection.root\",\"../data_main_barrel.root\"\)
...
${rootExecutable} -l -b -q comp.C++\(\"../Endcaps_preselection.root\",\"../data_main_endcaps.root\"\)
...
${rootExecutable} -l -b -q comp.C++\(\"../BsMC12_barrel_preselection.root\",\"../MC_main_barrel.root\"\)
...
${rootExecutable} -l -b -q comp.C++\(\"../BsMC12_endcaps_preselection.root\",\"../MC_main_endcaps.root\"\)
